        ...
        <div class="container py-5">
            ...
            <div class="row shop-wthree-info text-center">
                <div class="col-lg-3 shop-info-grid text-center mt-4">
                    <div class="product-shoe-info shoe">
                        <div class="men-thumb-item">
                            <img src="imgs/bag1.jpg" class="img-fluid" alt="bag" width="100px" height="auto">
                ...
                <div class="col-lg-3 shop-info-grid text-center mt-4">
                    <div class="product-shoe-info shoe">
                        <div class="men-thumb-item">
                            <img src="imgs/puffer1.jpeg" class="img-fluid" alt="jacket" width="100px" height="auto">

                        </div>
                        <div class="item-info-product">
                            <h4>
                                <a >Puffer Jacket (black) </a>
                            </h4>
                ...
                <div class="col-lg-3 shop-info-grid text-center mt-4">
                    <div class="product-shoe-info shoe">
                        <div class="men-thumb-item">
                            <img src="imgs/skirt.jpg" class="img-fluid" alt="skirt" width="100px" height="auto">

                        </div>
                        <div class="item-info-product">
                            <h4>
                                <a >Mini Skirt(black) </a>
                            </h4>
                ...
                <div class="col-lg-3 shop-info-grid text-center mt-4">
                    <div class="product-shoe-info shoe">
                        <div class="men-thumb-item">
                            <img src="imgs/prada-black-Monolith-Chelsea-boots.jpeg" class="img-fluid" alt="boots" width="100px" height="auto">

                        </div>
                        <div class="item-info-product">
                            <h4>
                                <a >Patent leather Monolith booties </a>
                            </h4>

                            <div class="product_price">
                                <div class="grid-price">
                                    <span class="money"><span class="line">$1799</span> $1675.00</span>
                                </div>
                            </div>
                            <ul class="stars">
                                <li><a href="#"><span class="fa fa-star" aria-hidden="true"></span></a></li>
